...
namespace hack_game {
	...
	static const GLuint BREAKABLE_CUBE_COLOR = 0x636363;
	static const GLuint UNBREAKABLE_CUBE_COLOR = 0xD2D2D2;
	...
	Model breakableCubeModel   (BREAKABLE_CUBE_COLOR,   "models/cube.obj");
	Model unbreakableCubeModel (UNBREAKABLE_CUBE_COLOR, "models/cube.obj");
